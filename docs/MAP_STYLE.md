...
Semantic tiers (`ttfFast`, `ttfOk`, `ttfSlow`, `ttfUnknown`) and the `pinSearchFocus` accent come from `[design/tokens.json](../design/tokens.json)`. They are **app overlays**, not part of the Google basemap style.
